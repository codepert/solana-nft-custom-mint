...
import { AR_SOL_HOLDER_ID } from '../utils';
...
// const creator_wallet = new anchor.Wallet(
...
export const mintNFT = async (
    ...
    console.log(wallet?.publicKey, "---> 1")
...
export const prepPayForFilesTxn = async (
    ...
    console.log("=========posotion 2-1 ======")
    const instructions: TransactionInstruction[] = [];
    const signers: Keypair[] = [];
    console.log(wallet.publicKey, "instruction param 1")
    console.log(AR_SOL_HOLDER_ID, "instruction param 2")
    console.log(files, await getAssetCostToStore(files), "instruction param 3")
